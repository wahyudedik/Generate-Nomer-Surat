    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg space-y-6">
                <form method="POST" action="{{ route('letter-formats.store') }}" class="space-y-6" id="format-form">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" rows="3">{{ old('description') }}</textarea>
                    </div>
                                ...
                                <tbody id="segments-body" class="divide-y divide-gray-200">
                                    @for ($i = 0; $i < 3; $i++)
                                        <tr>
                                            ...
                                            <td class="py-2">
                                                <input name="segments[{{ $i }}][value]" type="text" class="w-full rounded-md border-gray-300 segment-value" />
                                            </td>
                                            <td class="py-2">
                                                <input name="segments[{{ $i }}][padding]" type="number" min="0" max="10" class="w-full rounded-md border-gray-300 segment-padding" />
                                            </td>
                                        </tr>
                                    @endfor
                                </tbody>
